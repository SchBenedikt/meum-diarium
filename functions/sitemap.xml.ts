...
const STATIC_URLS: Array<{ loc: string; changefreq: string; priority: string; lastmod?: string }> = [
    ...
    { loc: '/projekt', changefreq: 'monthly', priority: '0.8', lastmod: TODAY },
    { loc: '/timeline', changefreq: 'daily', priority: '0.9', lastmod: TODAY },
    { loc: '/ki', changefreq: 'monthly', priority: '0.7', lastmod: TODAY },
    ...
    { loc: '/lernen/material', changefreq: 'weekly', priority: '0.8', lastmod: TODAY },
    { loc: '/vocab', changefreq: 'weekly', priority: '0.8', lastmod: TODAY },
    { loc: '/reader', changefreq: 'weekly', priority: '0.7', lastmod: TODAY },
    { loc: '/oer', changefreq: 'monthly', priority: '0.6', lastmod: TODAY },
    { loc: '/images', changefreq: 'monthly', priority: '0.5', lastmod: TODAY },
    { loc: '/api', changefreq: 'monthly', priority: '0.6', lastmod: TODAY },
    { loc: '/stats', changefreq: 'weekly', priority: '0.7', lastmod: TODAY },
    { loc: '/chat', changefreq: 'weekly', priority: '0.7', lastmod: TODAY },
    // Author pages
    ...
    { loc: '/sokrates', changefreq: 'weekly', priority: '0.9', lastmod: TODAY },
    // Author about pages
    ...
    { loc: '/sokrates/about', changefreq: 'monthly', priority: '0.7', lastmod: TODAY },
    // Author chat pages
    { loc: '/caesar/chat', changefreq: 'weekly', priority: '0.8', lastmod: TODAY },
    { loc: '/cicero/chat', changefreq: 'weekly', priority: '0.8', lastmod: TODAY },
    ...
    { loc: '/seneca/works/naturales-quaestiones', changefreq: 'monthly', priority: '0.8', lastmod: TODAY },
    { loc: '/catilina/works/catilinae-coniuratio', changefreq: 'monthly', priority: '0.8', lastmod: TODAY },
    { loc: '/sallust/works/bellum-catilinae', changefreq: 'monthly', priority: '0.8', lastmod: TODAY },
    { loc: '/sallust/works/bellum-jugurthinum', changefreq: 'monthly', priority: '0.8', lastmod: TODAY },
    // Simulation pages
    { loc: '/caesar/simulation', changefreq: 'weekly', priority: '0.8', lastmod: TODAY },
    { loc: '/cicero/simulation', changefreq: 'weekly', priority: '0.8', lastmod: TODAY },
