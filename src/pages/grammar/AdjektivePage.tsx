...
const adjektiveTopics = [
    {
        ...
        content: {
            ...
            rules: 'Die Adjektive der a/o-Deklination werden wie folgt dekliniert: Femininum nach der 1. Deklination (rosa, rosae, rosae, rosam, rosa), Maskulinum nach der 2. Deklination auf -us (dominus, domini, domino, dominum, domino), Neutrum nach der 2. Deklination auf -um (bellum, belli, bello, bellum, bello). Die Adjektive der 3. Deklination folgen den Mustern der i-Stämme: Nominativ/Akkusativ Plural auf -es, Genitiv Plural auf -ium, Dativ/Ablativ Plural auf -ibus. Bei Adjektiven auf -er im Maskulinum fällt der Stammvokal oft aus (pulcher, pulchri, pulchro, pulchrum, pulchro). Die Komparation wird durch die Suffixe -ior (Komparativ) und -issimus (Superlativ) gebildet, wobei der Komparativ nach der 3. Deklination und der Superlativ nach der a/o-Deklination dekliniert wird.',
            tables: [
                {
    ...
    },
    {
        ...
        content: {
            ...
            rules: 'Die Bildung des Komparativs erfolgt durch Anfügen von -ior an den Adjektivstamm: fortis → fortior, clarus → clarior, magnus → maior. Der Komparativ wird nach der 3. Deklination dekliniert: fortior, fortioris, forti, fortiorem, forti. Der Superlativ wird mit -issimus gebildet: fortis → fortissimus, clarus → clarissimus, magnus → maximus. Der Superlativ folgt der a/o-Deklination: fortissimus, fortissimi, fortissimo, fortissimum, fortissimo. Bei Adjektiven auf -er entfällt das -e- vor -rimus: pulcher → pulcherrimus. Bei Adjektiven auf -lis wird das -i- durch -limus ersetzt: facilis → facillimus. Die unregelmäßigen Steigerungen müssen einzeln gelernt werden: bonus → melior → optimus, malus → peior → pessimus, magnus → maior → maximus, parvus → minor → minimus.',
            tables: [
                {
