...
const partizipienTopics = [
    {
        ...
        content: {
            ...
            rules: [
                {
                    label: 'Bildung',
                    body: 'Das Partizip Präsens Aktiv wird vom Präsensstamm + -ns gebildet: amans (ich liebe), amans (du liebst), amat (sie lieben), amant (sie lieben).'
                },
                {
                    label: 'Endungen',
                    body: 'Die Endungen sind für alle Genera gleich: -ns (m), -ntis (f), -nt (n), -nt (pl).'
                },
                {
                    label: 'Deklinierung',
                    body: 'Das Partizip Präsens Aktiv wird wie ein Adjektiv dekliniert und stimmt mit dem Substantiv, das es bestimmt.'
                },
                {
                    label: 'Stammbildung',
                    body: 'Die Bildung erfolgt vom Präsensstamm, nicht vom Infinitiv.'
                },
                {
                    label: 'Verwendung',
                    body: 'Partizip Präsens Aktiv kann als Attribut oder als Prädikativ verwendet werden.'
                }
            ],
            tables: [
                {
    ...
    },
    {
        ...
        content: {
            ...
            rules: [
                {
                    label: 'Bildung',
                    body: 'Das Partizip Perfekt Passiv wird vom Perfektstamm + -us (m), -ae (f), -um (n) gebildet: amatus (geliebt), amata (geliebt), amatum (geliebt).'
                },
                {
                    label: 'Endungen',
                    body: 'Die Endungen sind für alle Genera gleich: -us (m), -ae (f), -um (n).'
                },
                {
                    label: 'Deklinierung',
                    body: 'Das Partizip Perfekt Passiv wird wie ein Adjektiv dekliniert und stimmt mit dem Substantiv, das es bestimmt.'
                },
                {
                    label: 'Stammbildung',
                    body: 'Die Bildung erfolgt vom Perfektstamm, nicht vom Präsensstamm.'
                },
                {
                    label: 'Verwendung',
                    body: 'Partizip Perfekt Passiv kann als Attribut oder Prädikativ verwendet werden.'
                }
            ],
            tables: [
                {
    ...
    },
    {
        ...
        content: {
            ...
            rules: [
                {
                    label: 'Bildung',
                    body: 'Das Partizip Futur Aktiv wird vom Partizip Präsens + -ūrus (m), -ūra (f), -ūrum (n) gebildet: amaturus (werden), amatura (werden), amaturum (werden).'
                },
                {
                    label: 'Endungen',
                    body: 'Die Endungen sind für alle Genera gleich: -ūrus (m), -ūra (f), -ūrum (n).'
                },
                {
                    label: 'Deklinierung',
                    body: 'Das Partizip Futur Aktiv wird wie ein Adjektiv dekliniert und stimmt mit dem Substantiv, das es bestimmt.'
                },
                {
                    label: 'Stammbildung',
                    body: 'Die Bildung erfolgt vom Partizip Präsensstamm, nicht vom Infinitiv.'
                },
                {
                    label: 'Verwendung',
                    body: 'Partizip Futur Aktiv kann als Attribut oder Prädikativ verwendet werden.'
                }
            ],
            tables: [
                {
    ...
    },
    {
        ...
        content: {
            ...
            rules: [
                {
                    label: 'Präsensinfinitiv',
                    body: 'Endet auf -āre, -ēre, -ere, -īre (unvollendet).'
                },
                {
                    label: 'Perfektinfinitiv',
                    body: 'Endet auf -isse, -īsī, -it, -imus, -istis, -ērunt/-ēre (abgeschlossen).'
                },
                {
                    label: 'Futurinfinitiv',
                    body: 'Endet auf -ūrus esse (werden).'
                },
                {
                    label: 'Infinitiv Perfekt',
                    body: 'Endet auf -um esse (gewesen sein).'
                },
                {
                    label: 'Infinitiv Futur',
                    body: 'Endet auf -ūrus esse (werden sein).'
                }
            ],
            tables: [
                {
    ...
    },
    {
        ...
        content: {
            ...
            rules: [
                {
                    label: 'Gerundium (Substantiv)',
                    body: 'Präsensstamm + -nd (tun), Genitiv ndi (des Tuns), Dativ ndo (dem Tuns), Akkusativ ndum (dem Tun), Ablativ ndo (vom Tun).'
                },
                {
                    label: 'Gerundium (Adjektiv)',
                    body: 'Präsensstamm + -ndō (getan), Genitiv ndō (des Tuns), Dativ ndō (dem Tuns), Akkusativ ndum (dem Tun), Ablativ ndō (vom Tun).'
                },
                {
                    label: 'Stammbildung',
                    body: 'Die Bildung erfolgt systematisch vom Präsensstamm, nicht vom Infinitiv.'
                }
            ],
            tables: [
                {
