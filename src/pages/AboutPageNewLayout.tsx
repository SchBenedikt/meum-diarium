      ...
      <main className="flex-1 container mx-auto px-4 pt-32 pb-24 max-w-7xl">
        ...
        <section className="mb-20">
          ...
          <p className="text-muted-foreground/80 leading-relaxed text-lg mb-6">
            Das neue Meum Diarium vereint mehrere große antike Persönlichkeiten in einer eigens dafür von Grund auf neu programmierten Plattform mit integriertem Admin-Portal, KI-Chat, Simulationen, wissenschaftlichen Artikeln und Lernfunktionen.
          </p>
          <Link
            to="/projekt"
            className="inline-flex items-center gap-2 text-primary font-semibold hover:underline group text-lg"
          >
