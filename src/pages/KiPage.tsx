...
import { MessageCircle, Zap, FileText, BookOpen, Sparkles, ArrowLeft, Bot, MessageSquare, Search } from 'lucide-react';
      ...
      <main className="flex-1">
          ...
          <motion.div variants={fadeUp()} className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
            <div className="space-y-4 flex-1">
              ...
              <p className="text-muted-foreground/70 max-w-2xl text-lg leading-relaxed">
                Eine vollständige, transparente Liste aller aktiven KI-Features in Meum Diarium – mit Endpunkt, Modell und Ort in der Anwendung.
              </p>
            </div>
        ...
        <section className="container mx-auto max-w-5xl px-4 pb-24">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            variants={fadeUp()}
            className="mt-12 p-8 rounded-2xl border border-primary/20 bg-gradient-to-br from-primary/5 via-transparent to-background text-center"
          >
            <div className="flex items-center justify-center gap-2 mb-4">
              <Sparkles className="h-5 w-5 text-primary" />
              <span className="text-primary font-bold text-xs uppercase tracking-widest">Grundsätzlich</span>
            </div>
            <p className="text-muted-foreground/80 max-w-2xl mx-auto leading-relaxed">
              KI wird in Meum Diarium als <strong>Werkzeug</strong> eingesetzt – nicht als Ersatz für menschliche Entscheidungen. 
              Alle KI-generierten Inhalte werden nach strengen Richtlinien geprüft. 
              Das Design, die Struktur und die Features der Anwendung sind eigenständig entwickelt.
            </p>
          </motion.div>
        </section>
      </main>
