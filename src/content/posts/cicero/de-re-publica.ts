...
const post: BlogPost = {
  ...
  slug: 'de-re-publica',
  author: 'cicero',
  title: 'De Re Publica - Ciceros Vermächtnis für die Nachwelt',
  
  excerpt: 'In den Jahren 54-51 v. Chr. verfasste Cicero sein philosophisches Hauptwerk über den idealen Staat - eine Verteidigung der Republik in ihrer Todesstunde.',
  historicalDate: '54-51 v. Chr.',
  historicalYear: -54,
  date: "2024-04-05",
  readingTime: 10,
  tags: ["Philosophie","Republik","Staatstheorie","Schriften","Ideal"],
  coverImage: '',
  content: {
    diary: ``,
    scientific: `## De Re Publica - Der idealstaat Ciceros (54-51 v. Chr.)

In den Jahren 54-51 v. Chr., als Cicero zunehmend aus der aktiven Politik gedrängt wurde, schuf er sein philosophisches Hauptwerk: "De Re Publica" (Über den Staat). Dieser Dialog über die beste Staatsform war mehr als eine akademische Übung - er war Ciceros Versuch, die Idee der römischen Republik für die Nachwelt zu bewahren, während sie vor seinen Augen zugrunde ging.
...
**Die platonische Inspiration:**
Erinnert an Platons "Mythos des Er" - aber römisch adaptiert.
...
Harsch - aber vielleicht wahr. Dennoch bleibt De Re Publica ein Monument des Denkens, ein Versuch, das Ideal festzuhalten, auch wenn die Realität scheiterte.

Cicero schrieb nicht für seine Zeit, sondern für die Ewigkeit. Und in diesem Sinne war De Re Publica ein Erfolg - ein leuchtendes Zeugnis republikanischer Ideale in der Dämmerung der Republik.`
  },
  translations: {
    "en": {
      "title": "",
