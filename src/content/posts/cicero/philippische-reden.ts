...
const post: BlogPost = {
  ...
  author: 'cicero',
  title: 'Die Philippischen Reden - Ciceros letzter Kampf',
  
  excerpt: 'Ciceros verzweifelter Kampf gegen Marcus Antonius 44-43 v. Chr. - vierzehn flammende Reden, die ihm das Leben kosteten, aber die Republik verteidigten.',
  historicalDate: '44-43 v. Chr.',
  historicalYear: -44,
  date: "2024-03-26",
  readingTime: 13,
  tags: ["Philippicae","Antonius","Republik","Octavian","Tod"],
  coverImage: '',
  content: {
    diary: ``,
    scientific: `## Die Philippischen Reden - Ciceros letzter Stand (44-43 v. Chr.)

Am 7. Dezember 43 v. Chr. wurde Marcus Tullius Cicero auf der Flucht von Soldaten des Marcus Antonius eingeholt und enthauptet. Sein Kopf und seine Hände - die Werkzeuge seiner Rhetorik - wurden auf dem Forum zur Schau gestellt. So endete das Leben des größten Redners Roms, erschlagen von der Macht jener Männer, gegen die er seine letzten Worte gerichtet hatte.

Die vierzehn "Philippischen Reden" gegen Marcus Antonius waren Ciceros letzter verzweifelter Versuch, die Römische Republik zu retten. Sie waren rhetorische Meisterwerke - und politische Naivität. Sie zeigen Cicero auf dem Höhepunkt seiner Kunst und im Abgrund seines politischen Urteilsvermögens.

### Nach Caesars Tod - Hoffnung auf Restauration
...
### Marcus Antonius - Der neue Feind
...
### Die zweite Philippica - Das rhetorische Meisterwerk (Oktober 44 v. Chr.)

Am 19. September hielt Antonius eine wütende Gegenrede, in der er Cicero persönlich attackierte. Cicero war nicht anwesend, ließ sich aber berichten.
...
### Octavian - Der junge Hoffnungsträger
...
Diese Arroganz würde sich rächen. Octavian war alles andere als naiv.

### Die Philippicae III-XIV - Eskalation zum Bürgerkrieg
...
Doch Cicero hatte grundlegend falsch kalkuliert:
...
**Die Hinrichtung:**
Cicero streckte seinen Hals aus der Sänfte. Seine letzten Worte (nach Plutarch):
*"Es ist nichts Neues unter denen, die mich töten."*

Kopf und Hände wurden abgeschlagen und nach Rom gebracht.

**Die Schändung:**
Fulvia, Antonius' Frau, soll Ciceros Zunge mit Nadeln durchstochen haben - Rache für die Philippischen Reden. Kopf und Hände wurden auf dem Rednerpult (rostra) ausgestellt, von dem aus Cicero so oft gesprochen hatte.
...
Cicero, der im Konsulat die Republik vor Catilina gerettet hatte, konnte sie 20 Jahre später nicht vor ihren Totengräbern retten. Seine Worte waren brilliant, aber nutzlos. Die Republik starb mit ihm.

Octavian, den er manipulieren wollte, wurde als Augustus der erste römische Kaiser. Antonius, den er als trunksüchtigen Trottel darstellte, war politisch kompetent genug, um die Macht zu teilen und Rache zu nehmen.

Die Philippischen Reden bleiben ein Zeugnis von Mut und Prinzipientreue - und von der Ohnmacht des Wortes gegen das Schwert.

**Senecas spätere Reflexion:**
*"Cicero hätte länger gelebt, wenn er geschwiegen hätte. Aber er zog es vor, als freier Mann zu sterben, als als Sklave zu leben."*

Die Geschichte hat ihm Recht gegeben - nicht als Politiker, aber als Mensch.`
  },
  translations: {
    "en": {
      "title": "",
