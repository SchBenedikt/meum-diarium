...
const post: BlogPost = {
  ...
  date: "2024-04-02",
  readingTime: 12,
  tags: ["Nero","Regierung","Reform","Burrus","Goldenes Zeitalter"],
  coverImage: '',
  content: {
    diary: ``,
    scientific: `## Quinquennium Neronis - Die fünf guten Jahre (54-59 n. Chr.)

"Quinquennium Neronis" - die fünf Jahre Neros - wurde später zum Synonym für gute Regierung. Zwischen 54 und 59 n. Chr. schien das unmögliche Experiment Senecas zu gelingen: Ein junger Kaiser, geleitet von philosophischen Prinzipien, regierte Rom mit Gerechtigkeit und Milde. Die Wirtschaft blühte, die Künste florierten, der Senat wurde respektiert. Es war, als hätte Platos Traum vom Philosophenkönig Gestalt angenommen. Doch es war nur eine Fassade - und der Alptraum wartete bereits.

### Die Machtkonstellation (54 n. Chr.)
...
**Neros erste Rede vor dem Senat (Oktober 54 n. Chr.):**
...
**Was das Quinquennium lehrte:**

**Möglichkeit:**
Gute Regierung ist unter einem Kaiser möglich - mit guten Beratern.

**Grenzen:**
Aber sie hängt vom Charakter des Herrschers ab. Nero war formbar, nicht weise.
...
Nero erwies sich als der törichte Mann. Und Seneca, der Weise, hatte versagt, ihn zu ändern.

Das Quinquennium Neronis bleibt als kurzer, goldener Moment in Erinnerung - die Ruhe vor dem Sturm, die Hoffnung vor der Verzweiflung, der Traum vor dem Albtraum.`
  },
  translations: {
    "en": {
      "title": "",
