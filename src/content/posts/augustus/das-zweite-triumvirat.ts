...
const post: BlogPost = {
  id: '1738250000015',
  slug: 'das-zweite-triumvirat',
  author: 'augustus',
  title: 'Das Zweite Triumvirat - Pakt mit dem Teufel',
  
  excerpt: 'Die brutale Allianz von Octavian, Antonius und Lepidus 43 v. Chr. - Proskriptionen, Machteilung und der Weg zur Alleinherrschaft.',
  historicalDate: '43 v. Chr.',
  historicalYear: -43,
  date: "2024-04-07",
  readingTime: 11,
  tags: ["Triumvirat","Antonius","Lepidus","Proskriptionen","Machtpolitik"],
  coverImage: '',
  content: {
    diary: ``,
    scientific: `## Das Zweite Triumvirat - Der Pakt von Bononia (43 v. Chr.)

Im Oktober 43 v. Chr. trafen sich drei Männer auf einer kleinen Insel im Fluss Reno bei Bononia (Bologna): Marcus Antonius, Marcus Aemilius Lepidus und der erst 20-jährige Octavian. In drei Tagen verhandelten sie die Aufteilung der römischen Welt. Das Ergebnis war das Zweite Triumvirat - eine legalisierte Diktatur zu dritt, besiegelt mit dem Blut Tausender römischer Bürger. Es war ein Wendepunkt: Die Republik war endgültig tot, ermordet von jenen, die vorgaben, sie zu rächen.
...
**Appian:**
Beschrieb Proskriptionen ausführlich und kritisch.

**Cassius Dio:**
Sah Triumvirat als notwendiges Übel.

**Sueton:**
Erwähnte Octavians Härte, relativierte später.
...
Brutal, aber präzise. Das Zweite Triumvirat war ein Pakt mit dem Teufel - und Octavian erwies sich als der cleverste Teufel von allen.`
  },
  translations: {
    "en": {
      "title": "",
