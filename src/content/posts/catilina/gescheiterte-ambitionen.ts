...
const post: BlogPost = {
  id: '1738250000009',
  slug: 'gescheiterte-ambitionen',
  author: 'catilina',
  title: 'Gescheiterte Ambitionen - Der Weg zur Verzweiflung',
  
  excerpt: 'Catilinas wiederholte Niederlagen bei den Konsulwahlen 64 und 63 v. Chr. trieben den verschuldeten Patrizier zur Verzweiflung und zur Verschwörung.',
  historicalDate: '64-63 v. Chr.',
  historicalYear: -64,
  date: "2024-04-01",
  readingTime: 11,
  tags: ["Konsulat","Wahlen","Schulden","Verzweiflung","Politik"],
  coverImage: '',
  content: {
    diary: ``,
    scientific: `## Catilinas gescheiterte Ambitionen (64-63 v. Chr.)

Lucius Sergius Catilina entstammte dem alten patrizischen Geschlecht der Sergier - einem der ältesten Adelsgeschlechter Roms. Seine Familie konnte ihre Abstammung bis zur Gründung der Stadt zurückverfolgen. Doch im 1. Jahrhundert v. Chr. bedeutete alter Adel wenig ohne politischen Erfolg und Geld. Catilina hatte weder das eine noch das andere - und seine verzweifelten Versuche, beides zu erlangen, würden ihn und Rom ins Verderben stürzen.
...
**Sallusts Urteil (De Coniuratione Catilinae):**
"Catilina war von edler Geburt, hatte einen starken Geist und Körper, aber einen bösartigen und verdorbenen Charakter."

Ob böse oder verzweifelt, tragisch oder schuldig - Catilinas gescheiterte Ambitionen zeigen, wie persönliches Scheitern zu politischer Gewalt führen kann.`
  },
  translations: {
    "en": {
      "title": "",
